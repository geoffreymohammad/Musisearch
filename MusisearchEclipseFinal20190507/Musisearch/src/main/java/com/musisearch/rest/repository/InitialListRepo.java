...
import com.musisearch.rest.rowmapper.InitialRowMapper;



@Repository
public class InitialListRepo implements InitialListInterface {
	...
	public ResultQuery getByPage(int pageNumber,  String inNama, Integer inId) {
		...
		try {
            ...
            simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate)
                         .withProcedureName("getInitialCount");
			...
			result = null;
			simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate)
					.withProcedureName("getInitialPage")
					.returningResultSet("RESULT_CURSOR", new InitialRowMapper());
	...
	public ResultQuery getAll(String inNama, Integer inId) {
		...
		try {
			...
			result = null;
			simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate)
					.withProcedureName("getInitialAll")
					.returningResultSet("RESULT_CURSOR", new InitialRowMapper());
	...
	@Override
	public ResultQuery insertInitial(Initial initial, Object created) {
		jdbcTemplate = new JdbcTemplate(dataSource);
		jdbcTemplate.setResultsMapCaseInsensitive(true);
		ResultQuery resultQuery = new ResultQuery();
	...
	@Override
	public ResultQuery updateInitial(String inNama, int inId, Object created) {
		jdbcTemplate = new JdbcTemplate(dataSource);
		jdbcTemplate.setResultsMapCaseInsensitive(true);
		ResultQuery resultQuery = new ResultQuery();
	...
	@Override
	public ResultQuery deleteInitial(Initial initial, Object created) {
